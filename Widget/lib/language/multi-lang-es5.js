 ...
 (function() {
     ...
     MultiLang.prototype.loadLangContent = function(fileName) {
         ...
         if (this.initArguments.dataType === 'js') {
             that.initArguments.callback.call(that, window.YJJXAJson[fileName], that.appLang)
             return;
         }

         var url = this.initArguments.version ?
             (this.initArguments.path + fileName + "?" + this.initArguments.version) :
             (this.initArguments.path + fileName)
